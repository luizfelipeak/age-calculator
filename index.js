...
function validation(form) {
  ...
  let validDay = false, validMonth = false, validYear = false;
  let birthdayDate, birthDay, birthMonth, birthYear, todayDate, currentDay, currentMonth, currentYear;
  todayDate = new Date();
  ...
  else if(formData.get("year") < (todayDate.getFullYear() - 110) || formData.get("year") > todayDate.getFullYear()) {
    yearLabel.classList.add("invalid");
    yearInput.classList.add("invalid");
  ...
  if(validDay === true && validMonth === true && validYear === true) {
    birthdayDate = new Date(formData.get("year"), formData.get("month") - 1, formData.get("day"));
    ...
    else if(!(formData.get("year") == birthYear) || !(formData.get("month") - 1 == birthMonth) || !(formData.get("day") == birthDay)) {
      dayLabel.classList.add("invalid");
      dayInput.classList.add("invalid");
      monthLabel.classList.add("invalid");
      monthInput.classList.add("invalid");
